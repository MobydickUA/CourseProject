...
{
    public partial class add_expense_type : Form
    {
        ...
        private void add_expnse_type_Click(object sender, EventArgs e)
        {
            if (textBox1.Text != "")
            {
                ...
                try
                {
                    string Query = "insert into transaction_types (ID, type, name, owner_id) values(NULL , 0, '" + textBox1.Text + "', '" + owner_id + "');";
                ...
                MessageBox.Show("Введіть назву витрати");
        }
    }
}
